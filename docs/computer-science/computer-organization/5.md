...
> 当 MTTF 过大时可能会不正确的结果，此时，AFR 更具参考价值
...
![nine of availability](images/Memory/nines_of_avail.png)
...
- 校验位 1($0001_2$) 检查 $1,3,5,7,9,11,\cdots$ 位，这些位的编号最右一位为1(00012、00112，01012，01112，10012，10112，…)。
- 校验位2($0010_2$)检查 $2,3,6,7,10,11,14,15,\cdots$ 位，这些位的编号最右第二位为1。
- 校验位3($0011_2$)检查 $3,7,14,15,\cdots$位，这些位的编号最右第三位为1。
- 校验位4($0100_2$)检查 $4\sim 7,12\sim 15,20\sim 23,\cdots$位，这些位的编号最右第三位为1。
- 校验位8(10002)检查$8\sim 15,24\sim 31,40\sim 47,\cdots$位，这些位的编号最右第四位为1

> 每个数据位都被至少两个奇偶校验位覆盖

![](Pasted%20image%2020260909211645.png)
